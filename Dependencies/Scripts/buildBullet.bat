...
if exist %BULLET_SLN% (
	...
	%MS_BUILD_PATH%\msbuild.exe %BULLET_SLN% /p:configuration=Debug /t:ALL_BUILD /p:Platform=x64 /p:PlatformToolset=v143
	%MS_BUILD_PATH%\msbuild.exe %BULLET_SLN% /p:configuration=Release /t:ALL_BUILD /p:Platform=x64 /p:PlatformToolset=v143
