...
public:
    /*
    * @brief Constructora del manager. No crear nuevos managers.
    */
    LuaManager();
    /*
    * @brief Destructora del manager. No borrar el manager.
    */
    ~LuaManager();
    ...
    */
    std::vector<CompValue> callLuaFunction(const std::string& name, const std::vector<CompValue>& parameters = {}, bool* success = nullptr);
    /*
