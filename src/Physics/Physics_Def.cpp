...
extern btVector3 Tapioca::toBtVector3(Vector3 v) { return btVector3(v.x, v.y, v.z); }

extern Vector3 Tapioca::toVector3(btVector3 v) { return Vector3(v.getX(), v.getY(), v.getZ()); }

extern btQuaternion Tapioca::toBtQuaternion(Vector3 v) {
