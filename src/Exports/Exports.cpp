...
static void registerLuaFunctions() {
    ...
    luabridge::getGlobalNamespace(lua->getLuaState())
        ...
        .addFunction(
            "loadScene", +[](std::string name) -> bool { return scenes->loadScene(name) != nullptr; })
        .addFunction(
            "exit", +[]() -> void { mainLoop->exit(); })
        .addFunction(
            "deleteScene", +[](std::string name) -> void { mainLoop->deleteScene(name); })
        .addFunction(
            "getScene", +[](std::string name) -> Scene* { return mainLoop->getScene(name); })
        .addFunction(
            "getLoadedScenes", +[]() -> std::unordered_map<std::string, Scene*> { return mainLoop->getLoadedScenes(); })
        //.addFunction("", +[]() -> void {})
        ...
        .addProperty(
            "emitting", [](ParticleSystemComponent* self) -> bool { return self->isEmitting(); },
            [](ParticleSystemComponent* self, bool emitting) { self->setEmitting(emitting); })
        .addProperty(
            "quota", [](ParticleSystemComponent* self) -> bool { return self->getQuota(); },
        ...
        .addProperty(
            "active", [](RigidBody* self) -> bool { return self->isActive(); },
        ...
        .addProperty(
            "name", [](Button* self) -> std::string { return self->getName(); },
            [](Button* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](Button* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](Button* self) -> Vector2 { return self->getPosition(); },
            [](Button* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](Button* self) -> Vector2 { return self->getSize(); },
            [](Button* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](Button* self) -> int { return self->getWindowFlags(); },
        ...
        .addProperty(
            "name", [](Image* self) -> std::string { return self->getName(); },
            [](Image* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](Image* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](Image* self) -> Vector2 { return self->getPosition(); },
            [](Image* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](Image* self) -> Vector2 { return self->getSize(); },
            [](Image* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](Image* self) -> int { return self->getWindowFlags(); },
        ...
        .addProperty(
            "name", [](InputText* self) -> std::string { return self->getName(); },
            [](InputText* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](InputText* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](InputText* self) -> Vector2 { return self->getPosition(); },
            [](InputText* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](InputText* self) -> Vector2 { return self->getSize(); },
            [](InputText* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](InputText* self) -> int { return self->getWindowFlags(); },
        ...
        .addProperty(
            "windowFlags", [](InputText* self) -> int { return self->getFlags(); },
        ...
        .addProperty(
            "name", [](ProgressBar* self) -> std::string { return self->getName(); },
            [](ProgressBar* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](ProgressBar* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](ProgressBar* self) -> Vector2 { return self->getPosition(); },
            [](ProgressBar* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](ProgressBar* self) -> Vector2 { return self->getSize(); },
            [](ProgressBar* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](ProgressBar* self) -> int { return self->getWindowFlags(); },
        ...
        .addProperty(
            "name", [](Slider* self) -> std::string { return self->getName(); },
            [](Slider* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](Slider* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](Slider* self) -> Vector2 { return self->getPosition(); },
            [](Slider* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](Slider* self) -> Vector2 { return self->getSize(); },
            [](Slider* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](Slider* self) -> int { return self->getWindowFlags(); },
        ...
        .addProperty(
            "name", [](Text* self) -> std::string { return self->getName(); },
            [](Text* self, const std::string& name) { self->setName(name); })
        .addProperty("transform", [](Text* self) -> Transform* { return self->getTransform(); })
        .addProperty(
            "position", [](Text* self) -> Vector2 { return self->getPosition(); },
            [](Text* self, const Vector2& position) { self->setPosition(position); })
        .addProperty(
            "size", [](Text* self) -> Vector2 { return self->getSize(); },
            [](Text* self, const Vector2& size) { self->setSize(size); })
        .addProperty(
            "windowFlags", [](Text* self) -> int { return self->getWindowFlags(); },
        ...
        .addFunction(
            "Animator", +[](Component* variable) -> Animator* { return static_cast<Animator*>(variable); })
        .addFunction(
            "CameraComponent",
        ...
        .addFunction(
            "LightDirComp", +[](Component* variable) -> LightDirComp* { return static_cast<LightDirComp*>(variable); })
        .addFunction(
            "LightPointComp",
        ...
        .addFunction(
            "MeshRenderer", +[](Component* variable) -> MeshRenderer* { return static_cast<MeshRenderer*>(variable); })
        .addFunction(
            "ParticleSystemComponent",
            +[](Component* variable) -> ParticleSystemComponent* {
                return static_cast<ParticleSystemComponent*>(variable);
            })
        .addFunction(
            "PlaneComponent",
        ...
        .addFunction(
            "RigidBody", +[](Component* variable) -> RigidBody* { return static_cast<RigidBody*>(variable); })
        .addFunction(
            "AudioListenerComponent",
            +[](Component* variable) -> AudioListenerComponent* {
                return static_cast<AudioListenerComponent*>(variable);
            })
        .addFunction(
            "AudioSourceComponent",
            +[](Component* variable) -> AudioSourceComponent* { return static_cast<AudioSourceComponent*>(variable); })
        .addFunction(
            "Button", +[](Component* variable) -> Button* { return static_cast<Button*>(variable); })
        .addFunction(
            "Image", +[](Component* variable) -> Image* { return static_cast<Image*>(variable); })
        .addFunction(
            "ImageTextButton",
            +[](Component* variable) -> ImageTextButton* { return static_cast<ImageTextButton*>(variable); })
        .addFunction(
            "InputText", +[](Component* variable) -> InputText* { return static_cast<InputText*>(variable); })
        .addFunction(
            "Line", +[](Component* variable) -> Line* { return static_cast<Line*>(variable); })
        .addFunction(
            "ProgressBar", +[](Component* variable) -> ProgressBar* { return static_cast<ProgressBar*>(variable); })
        .addFunction(
            "Slider", +[](Component* variable) -> Slider* { return static_cast<Slider*>(variable); })
        .addFunction(
            "Text", +[](Component* variable) -> Text* { return static_cast<Text*>(variable); })
        .endNamespace()
        .endNamespace();
}
